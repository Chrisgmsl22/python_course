...
class Calculadora(tk.Tk):
    def __init__(self):
        ...
        #Caja de texto
        self.entrada = None
        #Variable asociada al método de entrada (StringVar)
        self.entrada_texto = tk.StringVar()
        #Creamos los componentes
        self._creacion_componentes()

    #Métodos de clase
    #Método para la creaciónd de los componentes
    ...
    def _evento_limpiar(self):
        #Limpiamos el contenido de la caja de texto
        self.expresion = ''
    ...
    def _evento_evaluar(self):
        try:
            if self.expresion:
                resultado = str(eval(self.expresion)) #Eval evalua la expresión string como una de tipo aritmetica
