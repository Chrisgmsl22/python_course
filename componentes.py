...
class ComponentesVentana(tk.Tk):
    ...
    def _crear_componentes_tabulador4(self, tabulador):
        ...
        boton_imagen = ttk.Button(tabulador, image=imagen, command=mostrar_imagen)
    ...
    def _crear_componentes_tabulador5(self, tabulador):
        ...
        #Métodos para el control de la barra de progreso
        def ejecutar_barra():
            barra_progreso['maximum'] = 100 #100% es el máximo
            #Recorremos de 0 a 100
        ...
        def detener_despues():
            esperar_ms = 1000
            self.after(esperar_ms, barra_progreso.stop()) #indicamos la cantidad de segundos
            #Para que cuando se cumpla, se mande a llamar el metodo stop
        ...
        boton_despues = ttk.Button(tabulador, text='Detener ejecución despues',
                                   command=detener_despues)
    ...
    def _crear_tabs(self):
        ...
        #Agregamos un marco para agregar dentro del tab y organizar elementos agregados
        ...
        #Creamos los componentes del cuarto tab
